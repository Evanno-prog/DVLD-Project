...
namespace DVLD_DataAccess
{
    public class clsTestAppointmentData
    {
        ...
        ref DateTime AppointmentDate, ref float PaidFees, ref int CreatedByUserID, ref bool IsLocked, ref int
 ...
 order by TestAppointmentID Desc";
        ...
        public static DataTable GetApplicationTestAppointmentsPerTestType(int LocalDrivingLicenseApplicationID, int
       TestTypeID)
        {
            DataTable dt = new DataTable();
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
...
(@TestTypeID,@LocalDrivingLicenseApplicationID,@AppointmentDate,@PaidFees,@CreatedByUserID,0,@RetakeTestApplicationID);
 ...
 SELECT SCOPE_IDENTITY();";
        ...
        public static bool UpdateTestAppointment(int TestAppointmentID, int TestTypeID, int
